...
<link rel="stylesheet" href="{!! asset('css/plugins/dataTables/datatables.min.css') !!}" />
	<div ng-controller="categoryController"  class="wrapper wrapper-content animated fadeInRight">
		<div class="row">
			<div class="col-lg-12">
                    ...
                    @foreach ($categorys as $row)
                        <tr class="gradeX">
                            ...
                            <td>
                                ...
                                <a href=" {{ route('admin.category.edit', $row->id) }}" class="btn btn-primary" ><i class="fa fa-edit"></i></a>
...
@section('scripts')
    ...
    <script src="{!! asset('js/controller/admin/categoryController.js') !!}"></script>
        ...
        $(document).ready(function(){
            ...
            $('.dataTables-example').DataTable({
                ...
                buttons: [
                    // { extend: 'copy'},
                    // {extend: 'csv'},
                    {extend: 'excel', title: 'Categorias'},
                    {extend: 'pdf', title: 'Categorias'},
                    {extend: 'print',
